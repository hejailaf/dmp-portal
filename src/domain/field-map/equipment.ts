...
export const equipmentConfig: ObjectTypeConfig = {
  ...
  fields: [
    ...
    { key: 'manufacturer', label: 'Manufacturer', input: 'text', appliesTo: ['ADD', 'CHANGE'], requiredFor: ['ADD'], maxLength: 30, configurable: true },
    { key: 'model', label: 'Model Number', input: 'text', appliesTo: ['ADD', 'CHANGE'], requiredFor: ['ADD'], maxLength: 20, configurable: true },
    { key: 'serialNumber', label: 'Serial Number', input: 'text', appliesTo: ['ADD', 'CHANGE'], maxLength: 18, configurable: true },
    {
      key: 'planningPlant',
    ...
    { key: 'engTagNo', label: 'Eng. Tag no.', input: 'text', appliesTo: ['ADD', 'CHANGE'], maxLength: 30, configurable: true },
    { key: 'pidNo', label: 'P&ID no.', input: 'text', appliesTo: ['ADD', 'CHANGE'], maxLength: 30, configurable: true },
    {
      key: 'deletionReason',
