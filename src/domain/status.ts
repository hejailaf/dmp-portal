...
//
// Who may do what:
//   - requester: submit / reopen their own request
//   - maintainer: start / complete requests assigned to them
//   - admin: every transition (reject is admin-only, per spec §4.2 which
//     lists "reject" under Admin — change the `allowed` row below if
//     maintainers should be able to reject too)
